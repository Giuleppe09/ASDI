...
HD_PWD='C:/Users/ladyc/Desktop/ASDI/VIVADO-PROJECTS/Riconoscitore di Sequenza/Riconoscitore di Sequenza.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RICONOSCITORE_DI_SEQ.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RICONOSCITORE_DI_SEQ.tcl
