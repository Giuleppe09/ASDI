...
HD_PWD='C:/Users/ladyc/Desktop/ASDI/Progetto_ASDI/Sistema_PO_PC/Sistema_PO_PC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sistemaPO_PC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sistemaPO_PC.tcl
