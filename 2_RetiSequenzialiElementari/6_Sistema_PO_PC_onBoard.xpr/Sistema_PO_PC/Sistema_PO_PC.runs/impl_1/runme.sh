...
HD_PWD='C:/Users/ladyc/Desktop/ASDI/Progetto_ASDI/Sistema_PO_PC/Sistema_PO_PC.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sistemaPO_PC.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sistemaPO_PC.tcl -notrace
