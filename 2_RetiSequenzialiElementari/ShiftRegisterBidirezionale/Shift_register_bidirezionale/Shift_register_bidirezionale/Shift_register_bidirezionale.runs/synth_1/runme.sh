...
HD_PWD='C:/Users/ladyc/Desktop/ASDI/Progetto_ASDI/Shift_register_bidirezionale/Shift_register_bidirezionale.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Behavioral.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Behavioral.tcl
