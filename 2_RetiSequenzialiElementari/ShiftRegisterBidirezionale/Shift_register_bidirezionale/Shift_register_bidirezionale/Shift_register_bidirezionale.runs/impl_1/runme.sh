...
HD_PWD='C:/Users/ladyc/Desktop/ASDI/Progetto_ASDI/Shift_register_bidirezionale/Shift_register_bidirezionale.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Behavioral.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Behavioral.tcl -notrace
