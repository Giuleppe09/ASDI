...
HD_PWD='C:/Users/ladyc/Desktop/ASDI/VIVADO-PROJECTS/Sistema_ROM_M_onBoard/Sistema_ROM_M_onBoard.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Sistema_ROM_M.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Sistema_ROM_M.tcl -notrace
