...
HD_PWD='C:/Users/ladyc/Desktop/ASDI/VIVADO-PROJECTS/Sistema_ROM_M_onBoard/Sistema_ROM_M_onBoard.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Sistema_ROM_M.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Sistema_ROM_M.tcl
